  ...
  const data = [
    {
      ...
      user: {
        avatar_url:
          "https://media0.giphy.com/avatars/ROWNTREES_UKI/qBeskGWlCrlO.jpg",
        banner_image: "",
        banner_url: "",
        ...
        description:
          "Welcome to the Official Rowntree's ® GIPHY page. Tag us if you use any of these on IG using @RowntreesUK ",
        is_verified: false,
        website_url:
